...
const Dashboard = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-text-dark mb-6">{t("overview")}</h1>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <InsightCard
              ...
              description="3 patients have missed =2 appointments. Consider overbooking double slots."
              icon={HistoryIcon}
              type="history"
            />
            <InsightCard
